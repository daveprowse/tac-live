...
> NOTE: I recommend creating a new and separate IAM user for the labs in this repository. This user should have administrative permissions and console access. See this link for details about creating new users: https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html
